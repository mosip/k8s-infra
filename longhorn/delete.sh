...
while true; do
    ...
    if [ $yn = "Y" ]
      then
        ...
        echo Removing iscsi
        kubectl delete -n $NS -f https://raw.githubusercontent.com/longhorn/longhorn/v1.4.2/deploy/prerequisite/longhorn-iscsi-installation.yaml
        echo Removing nfsv4 client
        kubectl delete -n $NS -f https://raw.githubusercontent.com/longhorn/longhorn/v1.4.2/deploy/prerequisite/longhorn-nfs-installation.yaml
        break
      else
        break
    fi
